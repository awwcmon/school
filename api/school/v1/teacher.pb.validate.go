...
func (m *CreateTeacherRequest) validate(all bool) error {
	...
	// no validation rules for BornAt
...
func (m *DeleteTeacherByIDRequest) validate(all bool) error {
	...
	if utf8.RuneCountInString(m.GetId()) < 6 {
		err := DeleteTeacherByIDRequestValidationError{
			field:  "Id",
...
func (m *UpdateTeacherByIDRequest) validate(all bool) error {
	...
	if utf8.RuneCountInString(m.GetId()) < 6 {
		err := UpdateTeacherByIDRequestValidationError{
			field:  "Id",
			reason: "value length must be at least 6 runes",
		}
		if !all {
...
func (m *Teacher) validate(all bool) error {
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, TeacherValidationError{
					field:  "Job",
					reason: "embedded message failed validation",
					cause:  err,
				})
...
func (m *GetTeacherByIDRequest) validate(all bool) error {
	...
	if utf8.RuneCountInString(m.GetId()) < 6 {
		err := GetTeacherByIDRequestValidationError{
			field:  "Id",
			reason: "value length must be at least 6 runes",
		}
		if !all {
...
func (m *DeleteTeacherByIDsRequest) validate(all bool) error {
	...
	if len(m.GetIds()) < 1 {
		err := DeleteTeacherByIDsRequestValidationError{
			field:  "Ids",
...
func (m *ListTeacherByIDsRequest) validate(all bool) error {
	...
	if len(m.GetIds()) < 1 {
		err := ListTeacherByIDsRequestValidationError{
			field:  "Ids",
			reason: "value must contain at least 1 item(s)",
		}
		if !all {
...
// Validate checks the field values on ListTeacherByLastIDRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ListTeacherByLastIDRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListTeacherByLastIDRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ListTeacherByLastIDRequestMultiError, or nil if none found.
func (m *ListTeacherByLastIDRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *ListTeacherByLastIDRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetLimit() <= 0 {
		err := ListTeacherByLastIDRequestValidationError{
			field:  "Limit",
	...
	if len(errors) > 0 {
		return ListTeacherByLastIDRequestMultiError(errors)
	}

	return nil
}

// ListTeacherByLastIDRequestMultiError is an error wrapping multiple
// validation errors returned by ListTeacherByLastIDRequest.ValidateAll() if
// the designated constraints aren't met.
type ListTeacherByLastIDRequestMultiError []error
...
// AllErrors returns a list of validation violation errors.
func (m ListTeacherByLastIDRequestMultiError) AllErrors() []error { return m }

// ListTeacherByLastIDRequestValidationError is the validation error returned
// by ListTeacherByLastIDRequest.Validate if the designated constraints aren't met.
type ListTeacherByLastIDRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListTeacherByLastIDRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListTeacherByLastIDRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListTeacherByLastIDRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListTeacherByLastIDRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListTeacherByLastIDRequestValidationError) ErrorName() string {
	return "ListTeacherByLastIDRequestValidationError"
}

// Error satisfies the builtin error interface
func (e ListTeacherByLastIDRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListTeacherByLastIDRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListTeacherByLastIDRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListTeacherByLastIDRequestValidationError{}

// Validate checks the field values on ListTeacherByLastIDReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ListTeacherByLastIDReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListTeacherByLastIDReply with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ListTeacherByLastIDReplyMultiError, or nil if none found.
func (m *ListTeacherByLastIDReply) ValidateAll() error {
	return m.validate(true)
}

func (m *ListTeacherByLastIDReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetTeachers() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ListTeacherByLastIDReplyValidationError{
						field:  fmt.Sprintf("Teachers[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return ListTeacherByLastIDReplyValidationError{
					field:  fmt.Sprintf("Teachers[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return ListTeacherByLastIDReplyMultiError(errors)
	}

	return nil
}

// ListTeacherByLastIDReplyMultiError is an error wrapping multiple validation
// errors returned by ListTeacherByLastIDReply.ValidateAll() if the designated
// constraints aren't met.
type ListTeacherByLastIDReplyMultiError []error
...
// AllErrors returns a list of validation violation errors.
func (m ListTeacherByLastIDReplyMultiError) AllErrors() []error { return m }

// ListTeacherByLastIDReplyValidationError is the validation error returned by
// ListTeacherByLastIDReply.Validate if the designated constraints aren't met.
type ListTeacherByLastIDReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListTeacherByLastIDReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListTeacherByLastIDReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListTeacherByLastIDReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListTeacherByLastIDReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListTeacherByLastIDReplyValidationError) ErrorName() string {
	return "ListTeacherByLastIDReplyValidationError"
}

// Error satisfies the builtin error interface
func (e ListTeacherByLastIDReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListTeacherByLastIDReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListTeacherByLastIDReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListTeacherByLastIDReplyValidationError{}
