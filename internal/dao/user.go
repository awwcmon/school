...
type UserDao interface {
	Create(ctx context.Context, record *model.User) error
	DeleteByID(ctx context.Context, id string) error
	UpdateByID(ctx context.Context, record *model.User) error
	...
	GetByLastID(ctx context.Context, lastID string, limit int, sort string) ([]*model.User, error)
}
...
func NewUserDao(collection *mongo.Collection, xCache cache.UserCache) UserDao {
	if xCache == nil {
...
func (d *userDao) deleteCache(ctx context.Context, id string) error {
	if d.cache != nil {
...
func (d *userDao) Create(ctx context.Context, record *model.User) error {
	if record.ID.IsZero() {
...
func (d *userDao) DeleteByID(ctx context.Context, id string) error {
...
func (d *userDao) UpdateByID(ctx context.Context, record *model.User) error {
...
func (d *userDao) updateDataByID(ctx context.Context, collection *mongo.Collection, table *model.User) error {
	if table.ID.IsZero() {
	...
	if table.RealName != "" {
		update["realName"] = table.RealName
	}
	if table.Roles != nil {
		update["roles"] = table.Roles
	}
	if table.Username != "" {
		update["username"] = table.Username
	}
	if table.Codes != nil {
		update["codes"] = table.Codes
	}
...
func (d *userDao) GetByID(ctx context.Context, id string) (*model.User, error) {
	...
	if errors.Is(err, database.ErrCacheNotFound) {
		...
		val, err, _ := d.sfg.Do(id, func() (interface{}, error) {
			...
			// set cache
			if err = d.cache.Set(ctx, id, record, cache.UserExpireTime); err != nil {
...
func (d *userDao) GetByIDs(ctx context.Context, ids []string) (map[string]*model.User, error) {
	// no cache
	if d.cache == nil {
		records := []*model.User{}
		oids := mgo.ConvertToObjectIDs(ids)
...
func (d *userDao) GetByLastID(ctx context.Context, lastID string, limit int, sort string) ([]*model.User, error) {
